...
def rebin_tof(input_workspace: MantidWorkspace, output_workspace: str | None = None) -> EventWorkspace:
    """
...
def polarization_report(workspace: MantidWorkspace) -> str:
    ...
    def div_plot1d(ratio: MantidWorkspace | None, y_label: str) -> str:
...
def main(input_workspace: EventWorkspace, outdir: str | None = None, publish: bool = False):
    """
    ...
    outdir: str | None
        The directory where the reduction files will be saved.
        If `None`, the output is set to /SNS/REF_M/IPTS-XXXX/shared/autoreduce,
