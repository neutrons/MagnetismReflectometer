...
class ReductionProcess:
    ...
    def __init__(
        ...
        log_file_handle: IO
            file object to write log messages to. If passed, `debug` is ignored.
        live: bool
        ...
        if isinstance(log_file_handle, IOBase):  # override the default debug log file
            self.logfile = log_file_handle
